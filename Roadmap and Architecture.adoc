...
* Full internal naming for instance data repository: `md:Model.modelingAuthoritySet | md:Model.scenarioTime | PROFILE_ABBREVIATION | md:Model.mRID`
* Example: http://conformity.eu/Planning/CGMES|2021-04-21T17:30:00Z|DL|urn:uuid:71d4b744-3b84-40f0-b17f-9a49a82ff18a 
** Modeling Authority Set: http://conformity.eu/Planning/CGMES
** Scenario Time: 2021-04-21T17:30:00Z
** Profile Abbreviation: DL
** Model MRID: urn:uuid:71d4b744-3b84-40f0-b17f-9a49a82ff18a
...
** For Steady State Hypothesis profile schema
...
* Graph naming follows the detailed pattern: 
